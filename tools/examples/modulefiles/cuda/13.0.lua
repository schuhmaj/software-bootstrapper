...
This module provides access to CUDA 13.0 installed in /work_fast/ge25zov/modules/nvidia/hpc_sdk/Linux_x86_64/25.9/cuda/13.0.
...
local cuda_root = "/work_fast/ge25zov/modules/nvidia/hpc_sdk/Linux_x86_64/25.9/cuda/13.0"
...
if not (isDir(cuda_root)) then
    LmodError("CUDA 13.0 installation not found in " .. cuda_root)
end
